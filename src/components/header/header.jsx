  ...
  useEffect(() => {
     navigator.geolocation.getCurrentPosition(
       async (position) => {
         ...
         setCity({state, dispatch, coords: {lat:res.lat, lon:res.lon, name:res.address.city}})        
       }, async () => {
         ...
         setCity({state, dispatch, coords: {lat:res.latitude, lon:res.longitude, name:res.address.city}})
       })
   }, [])   
