    ...
    active ? 
        <>
            ...
            <div className="dayInfo">
                ...
                <p><span>Lluvia:</span> {daily?.rain_sum[position]} {daily_units?.rain_sum}</p>
                <p><span>Precipitación:</span> {daily?.precipitation_sum[position]} {daily_units?.precipitation_sum}</p>
            </div>
        </>
        :
        <>
